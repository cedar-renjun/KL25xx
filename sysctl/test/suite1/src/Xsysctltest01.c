...
//! - \subpage test_xsysctl_register01
//! .
//! \file Xsysctltest01.c
//! \brief xsysctl test source file
//! \file Xsysctltest01.h
...
//*****************************************************************************
//
//!\page test_xsysctl_register01 test_xsysctl_register
//!
//!<h2>Description</h2>
//! SysCtl Peripheral Clock Source Set
//
//*****************************************************************************
...
{
    return "xsysctl, 001, SysCtl Peripheral Clock Source Set test";
}
