...
//! - \subpage test_xsysctl_register04
//! .
//! \file Xsysctltest04.c
//! \brief xsysctl test source file
//! \file Xsysctltest04.h
...
//*****************************************************************************
//
//!\page test_xsysctl_register04 test_xsysctl_register
//!
//!<h2>Description</h2>
//! 0 SysCtlPowerDown Enable
//! 1 SysCtlTempatureSensor Enable 
//! 2 Bod test
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief xsysctl 004 test of tempature sensor enable test .
//!
//! \return None.
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \brief xsysctl 004 test of Brown-Out Detector Control Register test .
//!
//! \return None.
//
//*****************************************************************************
