...
//*****************************************************************************
//
//!\page test_xadc_register01 test_xadc_register
//!
//!<h2>Description</h2>
...
//! 1 Interrupt enable.
//! 2 Interrupt disable.
//! 3 watchdog monitor enable.
//! 4 watchdog monitor disable.
//! 5 watchdog monitor setting.
//! 6 Resolution Set.
//!
//
//*****************************************************************************
...
static void adcResolutionSetTest(void)
{
	...
	unsigned long ulAdcThreshold[] = {12,489,523,4095,45,687,1,324,1254,598,5986,
        54,55555,58,47,58,15,65534};
	//
...
//
const tTestCase sTestXAdc000Register = {
    xadc001GetTest,
    xadc001Setup,
    xadc001TearDown,
    xadc001Execute
